...
def get_parse():
    ...
    # path, dir, files
    parser.add_argument('src', metavar='PATH', help='path of the source dataset')
    parser.add_argument('tgt', metavar='PATH', help='path of the target dataset')
    ...
    parser.add_argument('--max-epoches', metavar='ME', default=100, type=int, help='max number of epoches')
    ...
    parser.add_argument('--lamb', default=0.1, metavar='L', type=float, help="domain adversal loss control")
